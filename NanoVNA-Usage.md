...
The official manual of the NanoVNA has a section on [how to calibrate the NanoVNA](https://nanovna.com/?page_id=2). Here I will only focus on information missing from the documentation.
