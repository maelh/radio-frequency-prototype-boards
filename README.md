...
The screw terminal on the extended version reduces the amount of loose wires going off the board. Now, all the power wires from the sub-boards can be soldered onto large central power SMD pads, which have traces leading to the single central power screw terminal.
