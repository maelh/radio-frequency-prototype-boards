...
- *Extended board version:* inform your manufacturer to keep the silkscreen for the U.FL connectors, since it's on the bare PCB substrate (no solder mask underneath). To do so, use a remark like this: "Keep the silkscreen on the solder mask openings".
