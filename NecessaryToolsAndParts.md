...
- **Important:** attenuators and DC blocks
  - For both instruments above you should use attenuators, since the frontends cannot sustain much power. The TinySA will analyze external signals, such as from antennas or signal generators, so attenuators are necessary. The NanoVNA might also need them, when characterizing amplifiers or mixers.
