...
Since SMD parts should make solid connections, the smallest acceptable size is 0402 (1.0 mm × 0.5 mm). Smaller sizes will have their SMD pads reaching into the gap between two board pads, instead of being fully touching the board's pads.
...
## Test equipement
- NanoVNA
  - Many different versions, I use [NanoVNA-H4](https://nanovna.com/) ([where to buy](https://nanovna.com/?page_id=121) to avoid bad clones), MegaWattKS uses [NanoVNA-F](https://deepelec.com/nanovna-f/), both having a 4" screen.
