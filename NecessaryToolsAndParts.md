...
Since SMD parts should make solid connections, the smallest size would be 0402 (1.0 mm × 0.5 mm). Smaller sizes will have their SMD pads reaching into the gap between two board pads, instead of being fully touching the boards pads.
